		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nscustomertestztest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscustomertestztest-display": {
								"semanticObject": "nscustomertestztest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.customer.test.ztest",
									"url": sap.ui.require.toUrl("ns/customer/test/ztest")
								}
							}
						}
					}
